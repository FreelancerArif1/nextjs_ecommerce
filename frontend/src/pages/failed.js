...
const Failed = () => {
    ...
    return (
        <FrontendLayouts>
            <Meta title="Failed | Dhroobo" keywords="dhroobo keywords" decription="dhroobo decription" />

            {/* <div className="Aboutpage" id="success_page">
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="successMark">
                                ...
                                <Link href="/my_account" className="btn btn-dark btn-sm mb-3 mt-3"> Go to my account </Link> 
